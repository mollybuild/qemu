...
DEF_HELPER_3(sadd, tl, env, tl, tl)
DEF_HELPER_3(saddu, tl, env, tl, tl)
DEF_HELPER_3(ssub, tl, env, tl, tl)
DEF_HELPER_3(ssubu, tl, env, tl, tl)
DEF_HELPER_3(aadd, tl, env, tl, tl)
DEF_HELPER_3(aaddu, tl, env, tl, tl)
DEF_HELPER_3(asub, tl, env, tl, tl)
DEF_HELPER_3(asubu, tl, env, tl, tl)
DEF_HELPER_3(ssh1sadd, tl, env, tl, tl)
DEF_HELPER_3(sh1add, tl, env, tl, tl)

DEF_HELPER_3(padd_ws, tl, env, tl, tl)
DEF_HELPER_3(padd_w, tl, env, tl, tl)
DEF_HELPER_3(psub_w, tl, env, tl, tl)
DEF_HELPER_3(psadd_w, tl, env, tl, tl)
DEF_HELPER_3(psaddu_w, tl, env, tl, tl)
DEF_HELPER_3(pssub_w, tl, env, tl, tl)
DEF_HELPER_3(pssubu_w, tl, env, tl, tl)
DEF_HELPER_3(paadd_w, tl, env, tl, tl)
DEF_HELPER_3(paaddu_w, tl, env, tl, tl)
DEF_HELPER_3(pasub_w, tl, env, tl, tl)
DEF_HELPER_3(pasubu_w, tl, env, tl, tl)
DEF_HELPER_3(psh1add_w, tl, env, tl, tl)
DEF_HELPER_3(pssh1sadd_w, tl, env, tl, tl)
DEF_HELPER_3(pas_wx, tl, env, tl, tl)
DEF_HELPER_3(psa_wx, tl, env, tl, tl)
DEF_HELPER_3(psas_wx, tl, env, tl, tl)
DEF_HELPER_3(pssa_wx, tl, env, tl, tl)
DEF_HELPER_3(paas_wx, tl, env, tl, tl)
DEF_HELPER_3(pasa_wx, tl, env, tl, tl)
DEF_HELPER_3(predsum_ws, tl, env, tl, tl)
DEF_HELPER_3(predsumu_ws, tl, env, tl, tl)
