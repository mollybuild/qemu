...
#define ELEMS_H(target) (sizeof(target) * 8 / 16)   /* halfword elements count */
...
/* =========================================================================
 * Saturation Helper Functions (with local overflow tracking)
 * ========================================================================= */
...
target_ulong HELPER(padd_b)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    ...
    for (int i = 0; i < elems; i++) {
        ...
        uint8_t res = e1 + e2;  /* Unsigned addition, well-defined modulo arithmetic */
        rd = INSERT8(rd, res, i);
    }
    return rd;
}
 ...
 */
uint64_t HELPER(padd_w)(CPURISCVState *env, uint64_t rs1, uint64_t rs2)
{
    uint64_t rd = 0;
 ...
 */
uint64_t HELPER(padd_ws)(CPURISCVState *env, uint64_t rs1, uint64_t rs2)
{
    uint64_t rd = 0;
    int elems = 2;
 ...
 * For each word: rd[i] = rs1[i] - rs2[i] (modular)
 */
uint64_t HELPER(psub_w)(CPURISCVState *env, uint64_t rs1, uint64_t rs2)
{
    uint64_t rd = 0;
    int elems = 2;
 ...
 */
target_ulong HELPER(psh1add_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
uint64_t HELPER(psh1add_w)(CPURISCVState *env, uint64_t rs1, uint64_t rs2)
{
    uint64_t rd = 0;
    int elems = 2;
 ...
 */
target_ulong HELPER(pssh1sadd_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
    int sat = 0;
...
/**
 * PSSH1SADD.W - Saturating shift left by 1 and saturating add (32-bit, RV64 only)
 * For each word: rd[i] = sat32(sat32(rs1[i] << 1) + rs2[i])
 */
uint64_t HELPER(pssh1sadd_w)(CPURISCVState *env, uint64_t rs1, uint64_t rs2)
{
    uint64_t rd = 0;
    int elems = 2;
    int sat = 0;
 ...
 */
uint32_t HELPER(ssh1sadd)(CPURISCVState *env, uint32_t rs1, uint32_t rs2)
{
 ...
 */
target_ulong HELPER(psadd_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
    int sat = 0;
 ...
 */
uint64_t HELPER(psadd_w)(CPURISCVState *env, uint64_t rs1, uint64_t rs2)
{
    uint64_t rd = 0;
    int elems = 2;
    int sat = 0;
 ...
 */
target_ulong HELPER(psaddu_b)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_B(rd);
    int sat = 0;
 ...
 */
target_ulong HELPER(psaddu_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
    int sat = 0;
 ...
 */
uint64_t HELPER(psaddu_w)(CPURISCVState *env, uint64_t rs1, uint64_t rs2)
{
    uint64_t rd = 0;
    int elems = 2;
    int sat = 0;
 ...
 */
uint32_t HELPER(sadd)(CPURISCVState *env, uint32_t rs1, uint32_t rs2)
{
    int32_t a = (int32_t)rs1;
    int32_t b = (int32_t)rs2;
 ...
 */
uint32_t HELPER(saddu)(CPURISCVState *env, uint32_t rs1, uint32_t rs2)
{
    uint32_t a = rs1;
    uint32_t b = rs2;
 ...
 * For each byte: rd[i] = sat8(rs1[i] - rs2[i])
 */
target_ulong HELPER(pssub_b)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_B(rd);
    int sat = 0;
 ...
 * For each halfword: rd[i] = sat16(rs1[i] - rs2[i])
 */
target_ulong HELPER(pssub_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
    int sat = 0;
 ...
 * For each word: rd[i] = sat32(rs1[i] - rs2[i])
 */
uint64_t HELPER(pssub_w)(CPURISCVState *env, uint64_t rs1, uint64_t rs2)
{
    uint64_t rd = 0;
    int elems = 2;
    int sat = 0;
 ...
 * For each byte: rd[i] = usat8(rs1[i] - rs2[i])
 */
target_ulong HELPER(pssubu_b)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_B(rd);
    int sat = 0;
 ...
 * For each halfword: rd[i] = usat16(rs1[i] - rs2[i])
 */
target_ulong HELPER(pssubu_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
    int sat = 0;
 ...
 * For each word: rd[i] = usat32(rs1[i] - rs2[i])
 */
uint64_t HELPER(pssubu_w)(CPURISCVState *env, uint64_t rs1, uint64_t rs2)
{
    uint64_t rd = 0;
    int elems = 2;
    int sat = 0;
 ...
 */
uint32_t HELPER(ssub)(CPURISCVState *env, uint32_t rs1, uint32_t rs2)
{
    int32_t a = (int32_t)rs1;
    int32_t b = (int32_t)rs2;
 ...
 */
uint32_t HELPER(ssubu)(CPURISCVState *env, uint32_t rs1, uint32_t rs2)
{
    uint32_t a = rs1;
    uint32_t b = rs2;
 ...
 */
target_ulong HELPER(psati_h)(CPURISCVState *env, target_ulong rs1, target_ulong imm)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(pusati_h)(CPURISCVState *env, target_ulong rs1, target_ulong imm)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
uint64_t HELPER(psati_w)(CPURISCVState *env, uint64_t rs1, uint64_t imm)
{
    uint64_t rd = 0;
    int elems = 2;
 ...
 */
uint64_t HELPER(pusati_w)(CPURISCVState *env, uint64_t rs1, uint64_t imm)
{
    uint64_t rd = 0;
    int elems = 2;
 ...
 */
uint32_t HELPER(sati_32)(CPURISCVState *env, uint32_t rs1, uint32_t imm)
{
    int32_t a = (int32_t)rs1;
 ...
 */
uint32_t HELPER(usati_32)(CPURISCVState *env, uint32_t rs1, uint32_t imm)
{
    int32_t a = (int32_t)rs1;
    uint32_t max = (1U << imm) - 1;
    int sat = 0;
 ...
 */
uint64_t HELPER(sati_64)(CPURISCVState *env, uint64_t rs1, uint64_t imm)
{
 ...
 */
uint64_t HELPER(usati_64)(CPURISCVState *env, uint64_t rs1, uint64_t imm)
{
    int64_t a = (int64_t)rs1;
    uint64_t max = (1ULL << imm) - 1;
    int sat = 0;
 ...
 */
target_ulong HELPER(paadd_b)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_B(rd);
 ...
 */
target_ulong HELPER(paadd_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 * For each byte: rd[i] = (rs1[i] + rs2[i]) >> 1
 */
target_ulong HELPER(paaddu_b)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_B(rd);
 ...
 * For each halfword: rd[i] = (rs1[i] + rs2[i]) >> 1
 */
target_ulong HELPER(paaddu_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 * For each byte: rd[i] = (rs1[i] - rs2[i]) >> 1
 */
target_ulong HELPER(pasub_b)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_B(rd);
 ...
 * For each halfword: rd[i] = (rs1[i] - rs2[i]) >> 1
 */
target_ulong HELPER(pasub_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 * For each byte: rd[i] = (rs1[i] - rs2[i]) >> 1
 */
target_ulong HELPER(pasubu_b)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_B(rd);
 ...
 * For each halfword: rd[i] = (rs1[i] - rs2[i]) >> 1
 */
target_ulong HELPER(pasubu_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(pmseq_b)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_B(rd);
 ...
 * For each byte: rd[i] = 0xFF if rs1[i] < rs2[i], else 0x00
 */
target_ulong HELPER(pmslt_b)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_B(rd);
 ...
 * For each byte: rd[i] = 0xFF if rs1[i] < rs2[i], else 0x00
 */
target_ulong HELPER(pmsltu_b)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_B(rd);
 ...
 */
target_ulong HELPER(pmin_b)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_B(rd);
 ...
 * For each byte: rd[i] = min(rs1[i], rs2[i])
 */
target_ulong HELPER(pminu_b)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_B(rd);
 ...
 */
target_ulong HELPER(pmax_b)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_B(rd);
 ...
 * For each byte: rd[i] = max(rs1[i], rs2[i])
 */
target_ulong HELPER(pmaxu_b)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_B(rd);
 ...
 */
target_ulong HELPER(pmseq_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 * For each halfword: rd[i] = 0xFFFF if rs1[i] < rs2[i], else 0x0000
 */
target_ulong HELPER(pmslt_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 * For each halfword: rd[i] = 0xFFFF if rs1[i] < rs2[i], else 0x0000
 */
target_ulong HELPER(pmsltu_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(pmin_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 * For each halfword: rd[i] = min(rs1[i], rs2[i])
 */
target_ulong HELPER(pminu_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(pmax_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 * For each halfword: rd[i] = max(rs1[i], rs2[i])
 */
target_ulong HELPER(pmaxu_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(pslli_b)(CPURISCVState *env, target_ulong rs1, target_ulong imm)
{
    target_ulong rd = 0;
    int elems = ELEMS_B(rd);
 ...
 */
target_ulong HELPER(psll_bs)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_B(rd);
 ...
 */
target_ulong HELPER(pslli_h)(CPURISCVState *env, target_ulong rs1, target_ulong imm)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(psll_hs)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 * For each byte: rd[i] = rs1[i] >> imm
 */
target_ulong HELPER(psrli_b)(CPURISCVState *env, target_ulong rs1, target_ulong imm)
{
    target_ulong rd = 0;
    int elems = ELEMS_B(rd);
 ...
 * For each byte: rd[i] = rs1[i] >> rs2[4:0]
 */
target_ulong HELPER(psrl_bs)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_B(rd);
 ...
 * For each halfword: rd[i] = rs1[i] >> imm
 */
target_ulong HELPER(psrli_h)(CPURISCVState *env, target_ulong rs1, target_ulong imm)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 * For each halfword: rd[i] = rs1[i] >> rs2[4:0]
 */
target_ulong HELPER(psrl_hs)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(psrai_b)(CPURISCVState *env, target_ulong rs1, target_ulong imm)
{
    target_ulong rd = 0;
    int elems = ELEMS_B(rd);
    uint8_t shamt = imm & 0x07;
 ...
 */
target_ulong HELPER(psra_bs)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_B(rd);
    uint8_t shamt = rs2 & 0x07;
 ...
 */
target_ulong HELPER(psrai_h)(CPURISCVState *env, target_ulong rs1, target_ulong imm)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
    uint8_t shamt = imm & 0x0F;
 ...
 */
target_ulong HELPER(psra_hs)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
    uint8_t shamt = rs2 & 0x0F;
 ...
 */
target_ulong HELPER(psslai_h)(CPURISCVState *env, target_ulong rs1, target_ulong imm)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
    int sat = 0;
 ...
 */
target_ulong HELPER(psrari_h)(CPURISCVState *env, target_ulong rs1, target_ulong imm)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
    uint8_t shamt = imm & 0x0F;
...
/**
 * PSRARI.W - Packed 32-bit arithmetic shift right with rounding (immediate) (RV64 only)
 ...
 */
target_ulong HELPER(pssha_hs)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
    int sat = 0;
 ...
 */
target_ulong HELPER(psshar_hs)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
    int sat = 0;
...
/**
 * PSSHAR.WS - Packed 32-bit variable shift with rounding and saturation (RV64 only)
 * Positive shift left (saturating), negative shift right (rounded)
 */
...
/**
 * PSSHLR.HS - Packed 16-bit variable shift with rounding and unsigned saturation
...
/**
 * PSSHLR.WS - Packed 32-bit variable shift with rounding and unsigned saturation (RV64 only)
 * Positive shift left (saturating), negative shift right (logical, rounded)
 */
 ...
 */
target_ulong HELPER(pas_hx)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 * For each pair: {rd[2i] = rs1[2i] + rs2[2i+1], rd[2i+1] = rs1[2i+1] - rs2[2i]}
 */
target_ulong HELPER(psa_hx)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(psas_hx)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
    int sat = 0;
 ...
 */
target_ulong HELPER(pssa_hx)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
    int sat = 0;
 ...
 */
target_ulong HELPER(paas_hx)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(pasa_hx)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
...
/**
 * PSAS.WX - Word version of packed saturating add-subtract with exchange (RV64 only)
 */
...
/**
 * PSSA.WX - Word version of packed saturating subtract-add with exchange (RV64 only)
 */
...
/**
 * PAAS.WX - Word version of packed averaging add-subtract with exchange (RV64 only)
 */
...
/**
 * PASA.WX - Word version of packed averaging subtract-add with exchange (RV64 only)
 */
 ...
 */
target_ulong HELPER(predsum_bs)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
 ...
 */
target_ulong HELPER(predsumu_bs)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    uint64_t sum = rs2;
    int elems = ELEMS_B(rs1);
 ...
 * rd = rs2 + sum(sign_extend(rs1[i]))
 */
target_ulong HELPER(predsum_hs)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    int64_t sum = (int64_t)(int32_t)rs2;
 ...
 * rd = rs2 + sum(zero_extend(rs1[i]))
 */
target_ulong HELPER(predsumu_hs)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    uint64_t sum = rs2;
    int elems = ELEMS_H(rs1);
 ...
 */
target_ulong HELPER(ppaire_b)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(ppaireo_b)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(ppairoe_b)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(ppairo_b)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
...
/**
 * PPAIRE.H - Pair low halfwords of corresponding words (RV64 only)
 ...
 */
target_ulong HELPER(ppaireo_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
 ...
 */
target_ulong HELPER(ppairoe_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_W(rd);
 ...
 */
target_ulong HELPER(ppairo_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_W(rd);
...
/**
 * UNZIP8P - De-interleave bytes (RV64 only)
 */
...
/**
 * UNZIP8HP - De-interleave high bytes (RV64 only)
 */
 ...
 */
target_ulong HELPER(slx)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong rd)
{
 ...
 */
target_ulong HELPER(srx)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong rd)
{
    int shamt = (TARGET_LONG_BITS == 32) ? (rs2 & 0x1F) : (rs2 & 0x3F);
    target_ulong xrs1 = 0;
    target_ulong xrd = 0;
 ...
 */
target_ulong HELPER(mvm)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong rd)
{
 ...
 */
target_ulong HELPER(mvmn)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong rd)
{
 ...
 */
target_ulong HELPER(merge)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong rd)
{
 ...
 */
target_ulong HELPER(pmulh_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(pmulhsu_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(pmulhu_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(pmulhr_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(pmulhrsu_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(pmulhru_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
...
/**
 * PMULHRSU.W - Packed signed x unsigned 32-bit multiply high with rounding (RV64 only)
 */
 ...
 */
target_ulong HELPER(pmulh_h_b0)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(pmulh_h_b1)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
...
/**
 * PMULHSU.H.B0 - Multiply signed halfword by unsigned low byte, result high halfword
 */
target_ulong HELPER(pmulhsu_h_b0)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
...
/**
 * PMULHSU.H.B1 - Multiply signed halfword by unsigned high byte, result high halfword
 */
target_ulong HELPER(pmulhsu_h_b1)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
...
/**
 * MULHSU.H0 - 32-bit signed multiply by unsigned low halfword, result high 16 bits
 */
...
/**
 * MULHSU.H1 - 32-bit signed multiply by unsigned high halfword, result high 16 bits
 */
...
/**
 * PMULHSU.W.H0 - Multiply signed word by unsigned low halfword, result high word (RV64 only)
 */
...
/**
 * PMULHSU.W.H1 - Multiply signed word by unsigned high halfword, result high word (RV64 only)
 */
 ...
 */
target_ulong HELPER(pmul_h_b00)(CPURISCVState *env, target_ulong s1, target_ulong s2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(pmul_h_b01)(CPURISCVState *env, target_ulong s1, target_ulong s2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(pmul_h_b11)(CPURISCVState *env, target_ulong s1, target_ulong s2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(pmulsu_h_b00)(CPURISCVState *env, target_ulong s1, target_ulong s2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(pmulsu_h_b11)(CPURISCVState *env, target_ulong s1, target_ulong s2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(pmulu_h_b00)(CPURISCVState *env, target_ulong s1, target_ulong s2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
...
/**
 * PMULU.H.B01 - Unsigned multiply, rs1 low byte × rs2 high byte
 * For each halfword: rd[i] = rs1[i][7:0] * rs2[i][15:8] (unsigned)
 */
target_ulong HELPER(pmulu_h_b01)(CPURISCVState *env, target_ulong s1, target_ulong s2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(pmulu_h_b11)(CPURISCVState *env, target_ulong s1, target_ulong s2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
...
/**
 * PMUL.W.H01 - Multiply word by low halfword × high halfword
...
/**
 * PMUL.W.H11 - Multiply word by high halfword × high halfword
...
/**
 * PMULSU.W.H00 - Signed × unsigned multiply, low halfwords
...
/**
 * PMULSU.W.H11 - Signed × unsigned multiply, high halfwords
...
/**
 * PMULU.W.H01 - Unsigned multiply, low halfword × high halfword
 ...
 */
target_ulong HELPER(pm2sadd_h)(CPURISCVState *env, target_ulong s1, target_ulong s2)
{
    target_ulong rd = 0;
    ...
    for (int i = 0; i < elems; i++) {
        ...
        if ((s1_h0 == -32768) && (s1_h1 == -32768) && 
            ...
            /* Note: This addition can overflow 32 bits, but the specification
             * doesn't require saturation for the sum itself - only for the
             * special case above. The result is truncated to 32 bits. */
 ...
 *   result saturates to 0x7FFFFFFF and sets vxsat
 */
target_ulong HELPER(pm2sadd_hx)(CPURISCVState *env, target_ulong s1, target_ulong s2)
{
    target_ulong rd = 0;
    int elems = ELEMS_W(rd);  /* Number of 32-bit words */
    int global_sat = 0;
...
/**
 * MUL.H01 - 32-bit signed multiply, rs1 low halfword × rs2 high halfword
...
/**
 * MULSU.H00 - 32-bit signed × unsigned multiply, low halfwords
 * Returns product of low halfword of rs1 (signed) and low halfword of rs2 (unsigned)
 */
...
/**
 * MULSU.H11 - 32-bit signed × unsigned multiply, high halfwords
 * Returns product of high halfword of rs1 (signed) and high halfword of rs2 (unsigned)
 */
...
/**
 * MULU.H01 - 32-bit unsigned multiply, rs1 low halfword × rs2 high halfword
...
/**
 * MUL.W00 - 64-bit signed multiply, low word × low word
...
/**
 * MUL.W01 - 64-bit signed multiply, low word × high word
...
/**
 * MUL.W11 - 64-bit signed multiply, high word × high word
...
/**
 * MULSU.W00 - 64-bit signed × unsigned multiply, low word × low word
 * Returns full 64-bit product of low 32 bits of rs1 (signed) and low 32 bits of rs2 (unsigned)
 */
...
/**
 * MULSU.W11 - 64-bit signed × unsigned multiply, high word × high word
 * Returns full 64-bit product of high 32 bits of rs1 (signed) and high 32 bits of rs2 (unsigned)
 */
...
/**
 * MULU.W00 - 64-bit unsigned multiply, low word × low word
 * Returns full 64-bit product of low 32 bits of rs1 and low 32 bits of rs2 (unsigned)
 */
...
/**
 * MULU.W01 - 64-bit unsigned multiply, low word × high word
 * Returns full 64-bit product of low 32 bits of rs1 and high 32 bits of rs2 (unsigned)
 */
...
/**
 * MULU.W11 - 64-bit unsigned multiply, high word × high word
 * Returns full 64-bit product of high 32 bits of rs1 and high 32 bits of rs2 (unsigned)
 */
 ...
 */
target_ulong HELPER(pmhacc_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong dest)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(pmhaccsu_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong dest)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(pmhaccu_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong dest)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(pmhracc_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong dest)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
...
/**
 * PMHRACCSU.H - Packed signed x unsigned 16-bit multiply high with rounding and accumulate
 */
target_ulong HELPER(pmhraccsu_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong dest)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
...
/**
 * PMHRACCU.H - Packed unsigned 16-bit multiply high with rounding and accumulate
 */
target_ulong HELPER(pmhraccu_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong dest)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
uint64_t HELPER(pmhacc_w)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
    int elems = 2;
...
/**
 * PMHRACC.W - Packed signed 32-bit multiply high with rounding and accumulate (RV64 only)
 */
uint64_t HELPER(pmhracc_w)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
    int elems = 2;
...
/**
 * PMHACCSU.W - Packed signed x unsigned 32-bit multiply high with accumulate (RV64 only)
 */
uint64_t HELPER(pmhaccsu_w)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
    int elems = 2;
...
/**
 * PMHRACCSU.W - Packed signed x unsigned 32-bit multiply high with rounding and accumulate (RV64 only)
 */
uint64_t HELPER(pmhraccsu_w)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
    int elems = 2;
 ...
 */
uint64_t HELPER(pmhaccu_w)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
    int elems = 2;
...
/**
 * PMHRACCU.W - Packed unsigned 32-bit multiply high with rounding and accumulate (RV64 only)
 */
uint64_t HELPER(pmhraccu_w)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
    int elems = 2;
 ...
 */
uint32_t HELPER(mhacc)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint32_t dest)
{
    int32_t a = (int32_t)rs1;
    int32_t b = (int32_t)rs2;
 ...
 */
uint32_t HELPER(mhracc)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint32_t dest)
{
    int32_t a = (int32_t)rs1;
    int32_t b = (int32_t)rs2;
    int32_t d = (int32_t)dest;
 ...
 */
uint32_t HELPER(mhaccsu)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint32_t dest)
{
    int32_t a = (int32_t)rs1;
    uint32_t b = rs2;
    int32_t d = (int32_t)dest;
...
/**
 * MHRACCSU - 32-bit signed x unsigned multiply high with rounding and accumulate
 */
uint32_t HELPER(mhraccsu)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint32_t dest)
{
    int32_t a = (int32_t)rs1;
    uint32_t b = rs2;
    int32_t d = (int32_t)dest;
 ...
 */
uint32_t HELPER(mhaccu)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint32_t dest)
{
    uint32_t a = rs1;
    uint32_t b = rs2;
    uint32_t d = dest;
 ...
 */
uint32_t HELPER(mhraccu)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint32_t dest)
{
    uint32_t a = rs1;
    uint32_t b = rs2;
    uint32_t d = dest;
 ...
 */
target_ulong HELPER(pmhacc_h_b0)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong dest)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(pmhacc_h_b1)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong dest)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(pmhaccsu_h_b0)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong dest)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
target_ulong HELPER(pmhaccsu_h_b1)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong dest)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
 ...
 */
uint32_t HELPER(mhacc_h0)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint32_t dest)
{
    int32_t a = (int32_t)rs1;
    int16_t b = (int16_t)(rs2 & 0xFFFF);
    int32_t d = (int32_t)dest;
 ...
 */
uint32_t HELPER(mhacc_h1)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint32_t dest)
{
    int32_t a = (int32_t)rs1;
    int16_t b = (int16_t)((rs2 >> 16) & 0xFFFF);
    int32_t d = (int32_t)dest;
 ...
 */
uint32_t HELPER(mhaccsu_h0)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint32_t dest)
{
    int32_t a = (int32_t)rs1;
    uint16_t b = (uint16_t)(rs2 & 0xFFFF);
    int32_t d = (int32_t)dest;
 ...
 */
uint32_t HELPER(mhaccsu_h1)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint32_t dest)
{
    int32_t a = (int32_t)rs1;
    uint16_t b = (uint16_t)((rs2 >> 16) & 0xFFFF);
    int32_t d = (int32_t)dest;
 ...
 */
uint64_t HELPER(pmhacc_w_h0)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
 ...
 */
uint64_t HELPER(pmhacc_w_h1)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
...
/**
 * PMHACCSU.W.H0 - Multiply signed word by unsigned low halfword high accumulate (RV64 only)
 */
uint64_t HELPER(pmhaccsu_w_h0)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
...
/**
 * PMHACCSU.W.H1 - Multiply signed word by unsigned high halfword high accumulate (RV64 only)
 */
uint64_t HELPER(pmhaccsu_w_h1)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
 ...
 */
uint64_t HELPER(pmacc_w_h00)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
    int elems = 2;
...
/**
 * PMACC.W.H01 - Packed multiply-accumulate, rs1 low × rs2 high
 * For each word: rd[i] = dest[i] + (rs1[i][15:0] * rs2[i][31:16])
 */
uint64_t HELPER(pmacc_w_h01)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
    int elems = 2;
 ...
 */
uint64_t HELPER(pmacc_w_h11)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
    int elems = 2;
...
/**
 * PMACCSU.W.H00 - Packed signed × unsigned multiply-accumulate, low halfwords
 * For each word: rd[i] = dest[i] + (signed)rs1[i][15:0] * (unsigned)rs2[i][15:0]
 */
uint64_t HELPER(pmaccsu_w_h00)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
    int elems = 2;
...
/**
 * PMACCSU.W.H11 - Packed signed × unsigned multiply-accumulate, high halfwords
 * For each word: rd[i] = dest[i] + (signed)rs1[i][31:16] * (unsigned)rs2[i][31:16]
 */
uint64_t HELPER(pmaccsu_w_h11)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
    int elems = 2;
 ...
 */
uint64_t HELPER(pmaccu_w_h00)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
    int elems = 2;
...
/**
 * PMACCU.W.H01 - Packed unsigned multiply-accumulate, rs1 low × rs2 high
 * For each word: rd[i] = dest[i] + rs1[i][15:0] * rs2[i][31:16] (unsigned)
 */
uint64_t HELPER(pmaccu_w_h01)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
    int elems = 2;
 ...
 */
uint64_t HELPER(pmaccu_w_h11)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
    int elems = 2;
 ...
 */
uint32_t HELPER(macc_h00)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint32_t dest)
{
    int16_t s1_h0 = (int16_t)EXTRACT16(rs1, 0);
    int16_t s2_h0 = (int16_t)EXTRACT16(rs2, 0);
...
/**
 * MACC.H01 - 32-bit signed multiply-accumulate, rs1 low × rs2 high
 * dest = dest + (rs1[15:0] * rs2[31:16])
 */
uint32_t HELPER(macc_h01)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint32_t dest)
{
    int16_t s1_h0 = (int16_t)EXTRACT16(rs1, 0);
    int16_t s2_h1 = (int16_t)EXTRACT16(rs2, 1);
    int32_t d_h = (int32_t)dest;
 ...
 */
uint32_t HELPER(macc_h11)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint32_t dest)
{
    int16_t s1_h1 = (int16_t)EXTRACT16(rs1, 1);
    int16_t s2_h1 = (int16_t)EXTRACT16(rs2, 1);
    int32_t d_h = (int32_t)dest;
...
/**
 * MACCSU.H00 - 32-bit signed × unsigned multiply-accumulate, low halfwords
 * dest = dest + (rs1[15:0] * rs2[15:0]) with rs2 unsigned
 */
uint32_t HELPER(maccsu_h00)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint32_t dest)
{
    int16_t s1_h0 = (int16_t)EXTRACT16(rs1, 0);
    uint16_t s2_h0 = EXTRACT16(rs2, 0);
    int32_t d_h = (int32_t)dest;
...
/**
 * MACCSU.H11 - 32-bit signed × unsigned multiply-accumulate, high halfwords
 * dest = dest + (rs1[31:16] * rs2[31:16]) with rs2 unsigned
 */
uint32_t HELPER(maccsu_h11)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint32_t dest)
{
    int16_t s1_h1 = (int16_t)EXTRACT16(rs1, 1);
    uint16_t s2_h1 = EXTRACT16(rs2, 1);
    int32_t d_h = (int32_t)dest;
 ...
 */
uint32_t HELPER(maccu_h00)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint32_t dest)
{
    uint16_t s1_h0 = EXTRACT16(rs1, 0);
    uint16_t s2_h0 = EXTRACT16(rs2, 0);
    uint32_t d_h = dest;
...
/**
 * MACCU.H01 - 32-bit unsigned multiply-accumulate, rs1 low × rs2 high
 * dest = dest + (rs1[15:0] * rs2[31:16]) (unsigned)
 */
uint32_t HELPER(maccu_h01)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint32_t dest)
{
    uint16_t s1_h0 = EXTRACT16(rs1, 0);
    uint16_t s2_h1 = EXTRACT16(rs2, 1);
    uint32_t d_h = dest;
 ...
 */
uint32_t HELPER(maccu_h11)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint32_t dest)
{
    uint16_t s1_h1 = EXTRACT16(rs1, 1);
    uint16_t s2_h1 = EXTRACT16(rs2, 1);
    uint32_t d_h = dest;
...
/**
 * MACC.W00 - 64-bit signed multiply-accumulate, low word × low word
 * dest = dest + (rs1[31:0] * rs2[31:0])
 */
uint64_t HELPER(macc_w00)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    int32_t s1_w0 = (int32_t)EXTRACT32(rs1, 0);
    int32_t s2_w0 = (int32_t)EXTRACT32(rs2, 0);
...
/**
 * MACC.W01 - 64-bit signed multiply-accumulate, low word × high word
 * dest = dest + (rs1[31:0] * rs2[63:32])
 */
uint64_t HELPER(macc_w01)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    int32_t s1_w0 = (int32_t)EXTRACT32(rs1, 0);
    int32_t s2_w1 = (int32_t)EXTRACT32(rs2, 1);
    int64_t d_w = (int64_t)dest;
...
/**
 * MACC.W11 - 64-bit signed multiply-accumulate, high word × high word
 * dest = dest + (rs1[63:32] * rs2[63:32])
 */
uint64_t HELPER(macc_w11)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    int32_t s1_w1 = (int32_t)EXTRACT32(rs1, 1);
    int32_t s2_w1 = (int32_t)EXTRACT32(rs2, 1);
    int64_t d_w = (int64_t)dest;
...
/**
 * MACCSU.W00 - 64-bit signed × unsigned multiply-accumulate, low word × low word
 * dest = dest + (rs1[31:0] * rs2[31:0]) with rs2 interpreted as unsigned
 */
uint64_t HELPER(maccsu_w00)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    int32_t s1_w0 = (int32_t)EXTRACT32(rs1, 0);
    uint32_t s2_w0 = EXTRACT32(rs2, 0);
    int64_t d_w = (int64_t)dest;
...
/**
 * MACCSU.W11 - 64-bit signed × unsigned multiply-accumulate, high word × high word
 * dest = dest + (rs1[63:32] * rs2[63:32]) with rs2 interpreted as unsigned
 */
uint64_t HELPER(maccsu_w11)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    int32_t s1_w1 = (int32_t)EXTRACT32(rs1, 1);
    uint32_t s2_w1 = EXTRACT32(rs2, 1);
    int64_t d_w = (int64_t)dest;
...
/**
 * MACCU.W00 - 64-bit unsigned multiply-accumulate, low word × low word
 * dest = dest + (rs1[31:0] * rs2[31:0]) (unsigned)
 */
uint64_t HELPER(maccu_w00)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint32_t s1_w0 = EXTRACT32(rs1, 0);
    uint32_t s2_w0 = EXTRACT32(rs2, 0);
    uint64_t d_w = dest;
...
/**
 * MACCU.W01 - 64-bit unsigned multiply-accumulate, low word × high word
 * dest = dest + (rs1[31:0] * rs2[63:32]) (unsigned)
 */
uint64_t HELPER(maccu_w01)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint32_t s1_w0 = EXTRACT32(rs1, 0);
    uint32_t s2_w1 = EXTRACT32(rs2, 1);
    uint64_t d_w = dest;
...
/**
 * MACCU.W11 - 64-bit unsigned multiply-accumulate, high word × high word
 * dest = dest + (rs1[63:32] * rs2[63:32]) (unsigned)
 */
uint64_t HELPER(maccu_w11)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint32_t s1_w1 = EXTRACT32(rs1, 1);
    uint32_t s2_w1 = EXTRACT32(rs2, 1);
    uint64_t d_w = dest;
 ...
 */
target_ulong HELPER(pmulq_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
    int sat = 0;
 ...
 */
target_ulong HELPER(pmulqr_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_H(rd);
    int sat = 0;
 ...
 */
uint32_t HELPER(mqacc_h00)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint32_t dest)
{
 ...
 */
uint32_t HELPER(mqacc_h01)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint32_t dest)
{
    int16_t s1_h0 = (int16_t)(rs1 & 0xFFFF);
 ...
 */
uint32_t HELPER(mqacc_h11)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint32_t dest)
{
 ...
 */
uint32_t HELPER(mqracc_h00)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint32_t dest)
{
    int16_t s1_h0 = (int16_t)(rs1 & 0xFFFF);
    int16_t s2_h0 = (int16_t)(rs2 & 0xFFFF);
    int32_t d = (int32_t)dest;
 ...
 */
uint32_t HELPER(mqracc_h01)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint32_t dest)
{
    int16_t s1_h0 = (int16_t)(rs1 & 0xFFFF);
    int16_t s2_h1 = (int16_t)((rs2 >> 16) & 0xFFFF);
    int32_t d = (int32_t)dest;
 ...
 */
uint32_t HELPER(mqracc_h11)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint32_t dest)
{
    int16_t s1_h1 = (int16_t)((rs1 >> 16) & 0xFFFF);
    int16_t s2_h1 = (int16_t)((rs2 >> 16) & 0xFFFF);
    int32_t d = (int32_t)dest;
 ...
 */
uint64_t HELPER(mqacc_w00)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
 ...
 */
uint64_t HELPER(mqacc_w01)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    int32_t s1_w0 = (int32_t)(rs1 & 0xFFFFFFFF);
 ...
 */
uint64_t HELPER(mqacc_w11)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
...
/**
 * MQRACC.W00 - Q-format multiply accumulate with rounding, both low word (RV64)
 */
uint64_t HELPER(mqracc_w00)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    int32_t s1_w0 = (int32_t)(rs1 & 0xFFFFFFFF);
    int32_t s2_w0 = (int32_t)(rs2 & 0xFFFFFFFF);
    int64_t d = (int64_t)dest;
...
/**
 * MQRACC.W01 - Q-format multiply accumulate with rounding, rs1 low, rs2 high (RV64)
 */
uint64_t HELPER(mqracc_w01)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    int32_t s1_w0 = (int32_t)(rs1 & 0xFFFFFFFF);
    int32_t s2_w1 = (int32_t)((rs2 >> 32) & 0xFFFFFFFF);
    int64_t d = (int64_t)dest;
...
/**
 * MQRACC.W11 - Q-format multiply accumulate with rounding, both high word (RV64)
 */
uint64_t HELPER(mqracc_w11)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    int32_t s1_w1 = (int32_t)((rs1 >> 32) & 0xFFFFFFFF);
    int32_t s2_w1 = (int32_t)((rs2 >> 32) & 0xFFFFFFFF);
    int64_t d = (int64_t)dest;
...
/**
 * PMQACC.W.H00 - Packed Q-format multiply accumulate, low halfword (RV64)
 */
uint64_t HELPER(pmqacc_w_h00)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
...
/**
 * PMQACC.W.H01 - Packed Q-format multiply accumulate, rs1 low, rs2 high (RV64)
 */
uint64_t HELPER(pmqacc_w_h01)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
...
/**
 * PMQACC.W.H11 - Packed Q-format multiply accumulate, both high halfword (RV64)
 */
uint64_t HELPER(pmqacc_w_h11)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
...
/**
 * PMQRACC.W.H00 - Packed Q-format multiply accumulate with rounding, low halfword (RV64)
 */
uint64_t HELPER(pmqracc_w_h00)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
...
/**
 * PMQRACC.W.H01 - Packed Q-format multiply accumulate with rounding, rs1 low, rs2 high (RV64)
 */
uint64_t HELPER(pmqracc_w_h01)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
...
/**
 * PMQRACC.W.H11 - Packed Q-format multiply accumulate with rounding, both high halfword (RV64)
 */
uint64_t HELPER(pmqracc_w_h11)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
 ...
 */
target_ulong HELPER(pmq2add_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_W(rd);
 ...
 */
target_ulong HELPER(pmqr2add_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_W(rd);
 ...
 */
target_ulong HELPER(pmq2adda_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong dest)
{
    target_ulong rd = 0;
    int elems = ELEMS_W(rd);
 ...
 */
target_ulong HELPER(pmqr2adda_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong dest)
{
    target_ulong rd = 0;
    int elems = ELEMS_W(rd);
 ...
 */
uint64_t HELPER(pmq2adda_w)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    int32_t s1_w0 = (int32_t)EXTRACT32(rs1, 0);
    int32_t s1_w1 = (int32_t)EXTRACT32(rs1, 1);
    int32_t s2_w0 = (int32_t)EXTRACT32(rs2, 0);
...
/**
 * PMQR2ADDA.W - Add two Q-format products with rounding and accumulate (word, RV64 only)
 */
uint64_t HELPER(pmqr2adda_w)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    int32_t s1_w0 = (int32_t)EXTRACT32(rs1, 0);
    int32_t s1_w1 = (int32_t)EXTRACT32(rs1, 1);
    int32_t s2_w0 = (int32_t)EXTRACT32(rs2, 0);
 ...
 */
target_ulong HELPER(pm2add_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_W(rd);
 ...
 */
target_ulong HELPER(pm2addsu_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_W(rd);
 ...
 */
target_ulong HELPER(pm2addu_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_W(rd);
 ...
 */
target_ulong HELPER(pm2add_hx)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_W(rd);
 ...
 * For each word: rd[i] = rs1[2i] * rs2[2i] - rs1[2i+1] * rs2[2i+1]
 */
target_ulong HELPER(pm2sub_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_W(rd);
 ...
 */
target_ulong HELPER(pm2adda_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong dest)
{
    target_ulong rd = 0;
    int elems = ELEMS_W(rd);
...
/**
 * PM2ADDASU.H - Add two products horizontally with accumulate (signed x unsigned)
 */
target_ulong HELPER(pm2addasu_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong dest)
{
    target_ulong rd = 0;
    int elems = ELEMS_W(rd);
 ...
 */
target_ulong HELPER(pm2addau_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong dest)
{
    target_ulong rd = 0;
    int elems = ELEMS_W(rd);
 ...
 */
target_ulong HELPER(pm2adda_hx)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong dest)
{
    target_ulong rd = 0;
    int elems = ELEMS_W(rd);
 ...
 */
target_ulong HELPER(pm2suba_h)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong dest)
{
    target_ulong rd = 0;
    int elems = ELEMS_W(rd);
 ...
 */
target_ulong HELPER(pm2suba_hx)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong dest)
{
    target_ulong rd = 0;
    int elems = ELEMS_W(rd);
 ...
 */
uint64_t HELPER(pm2adda_w)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    int32_t s1_w0 = (int32_t)EXTRACT32(rs1, 0);
    int32_t s1_w1 = (int32_t)EXTRACT32(rs1, 1);
    int32_t s2_w0 = (int32_t)EXTRACT32(rs2, 0);
...
/**
 * PM2ADDASU.W - Add two products horizontally with accumulate (signed x unsigned, RV64 only)
 */
uint64_t HELPER(pm2addasu_w)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    int32_t s1_w0 = (int32_t)EXTRACT32(rs1, 0);
    int32_t s1_w1 = (int32_t)EXTRACT32(rs1, 1);
    uint32_t s2_w0 = EXTRACT32(rs2, 0);
...
/**
 * PM2ADDAU.W - Add two products horizontally with accumulate (unsigned, RV64 only)
 */
uint64_t HELPER(pm2addau_w)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint32_t s1_w0 = EXTRACT32(rs1, 0);
    uint32_t s1_w1 = EXTRACT32(rs1, 1);
    uint32_t s2_w0 = EXTRACT32(rs2, 0);
...
/**
 * PM2ADDA.WX - Add cross products horizontally with accumulate (word, RV64 only)
 */
uint64_t HELPER(pm2adda_wx)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    int32_t s1_w0 = (int32_t)EXTRACT32(rs1, 0);
    int32_t s1_w1 = (int32_t)EXTRACT32(rs1, 1);
    int32_t s2_w0 = (int32_t)EXTRACT32(rs2, 0);
...
/**
 * PM2SUBA.W - Subtract two products horizontally with accumulate (word, RV64 only)
 */
uint64_t HELPER(pm2suba_w)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    int32_t s1_w0 = (int32_t)EXTRACT32(rs1, 0);
    int32_t s1_w1 = (int32_t)EXTRACT32(rs1, 1);
    int32_t s2_w0 = (int32_t)EXTRACT32(rs2, 0);
...
/**
 * PM2SUBA.WX - Subtract cross products horizontally with accumulate (word, RV64 only)
 */
uint64_t HELPER(pm2suba_wx)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    int32_t s1_w0 = (int32_t)EXTRACT32(rs1, 0);
    int32_t s1_w1 = (int32_t)EXTRACT32(rs1, 1);
    int32_t s2_w0 = (int32_t)EXTRACT32(rs2, 0);
 ...
 */
target_ulong HELPER(pm4add_b)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_W(rd);
 ...
 */
target_ulong HELPER(pm4addsu_b)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_W(rd);
 ...
 */
target_ulong HELPER(pm4addu_b)(CPURISCVState *env, target_ulong rs1, target_ulong rs2)
{
    target_ulong rd = 0;
    int elems = ELEMS_W(rd);
 ...
 */
target_ulong HELPER(pm4adda_b)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong dest)
{
    target_ulong rd = 0;
    int elems = ELEMS_W(rd);
...
/**
 * PM4ADDASU.B - Add four products horizontally with accumulate (signed x unsigned)
 */
target_ulong HELPER(pm4addasu_b)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong dest)
{
    target_ulong rd = 0;
    int elems = ELEMS_W(rd);
 ...
 */
target_ulong HELPER(pm4addau_b)(CPURISCVState *env, target_ulong rs1, target_ulong rs2, target_ulong dest)
{
    target_ulong rd = 0;
    int elems = ELEMS_W(rd);
 ...
 */
uint64_t HELPER(pm4adda_h)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    int16_t s1_h0 = (int16_t)EXTRACT16(rs1, 0);
    int16_t s1_h1 = (int16_t)EXTRACT16(rs1, 1);
    int16_t s1_h2 = (int16_t)EXTRACT16(rs1, 2);
...
/**
 * PM4ADDASU.H - Add four products horizontally with accumulate (signed x unsigned, RV64 only)
 */
uint64_t HELPER(pm4addasu_h)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    int16_t s1_h0 = (int16_t)EXTRACT16(rs1, 0);
    int16_t s1_h1 = (int16_t)EXTRACT16(rs1, 1);
    int16_t s1_h2 = (int16_t)EXTRACT16(rs1, 2);
...
/**
 * PM4ADDAU.H - Add four products horizontally with accumulate (unsigned, RV64 only)
 */
uint64_t HELPER(pm4addau_h)(CPURISCVState *env, uint64_t rs1, uint64_t rs2, uint64_t dest)
{
    uint16_t s1_h0 = EXTRACT16(rs1, 0);
    uint16_t s1_h1 = EXTRACT16(rs1, 1);
    uint16_t s1_h2 = EXTRACT16(rs1, 2);
 ...
 * rd_pair += {rs1[i] + rs2[i]}
 */
uint64_t HELPER(pwadda_b)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t rd)
{
    uint64_t result = 0;
...
/**
 * PWADDAU.B - Packed widening byte to halfword unsigned addition with accumulate (RV32)
 */
uint64_t HELPER(pwaddau_b)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t rd)
{
    uint64_t result = 0;
...
/**
 * PWSUBA.B - Packed widening byte to halfword subtraction with accumulate (RV32)
 */
uint64_t HELPER(pwsuba_b)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t rd)
{
    uint64_t result = 0;
...
/**
 * PWSUBAU.B - Packed widening byte to halfword unsigned subtraction with accumulate (RV32)
 */
uint64_t HELPER(pwsubau_b)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t rd)
{
    uint64_t result = 0;
 ...
 */
uint64_t HELPER(pwadda_h)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t rd)
{
    uint64_t result = 0;
...
/**
 * PWADDAU.H - Packed widening halfword to word unsigned addition with accumulate (RV32)
 */
uint64_t HELPER(pwaddau_h)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t rd)
{
    uint64_t result = 0;
...
/**
 * PWSUBA.H - Packed widening halfword to word subtraction with accumulate (RV32)
 */
uint64_t HELPER(pwsuba_h)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t rd)
{
    uint64_t result = 0;
...
/**
 * PWSUBAU.H - Packed widening halfword to word unsigned subtraction with accumulate (RV32)
 */
uint64_t HELPER(pwsubau_h)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t rd)
{
    uint64_t result = 0;
 ...
 */
uint64_t HELPER(wadda)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t rd)
{
    int64_t a = (int32_t)rs1;
    int64_t b = (int32_t)rs2;
 ...
 */
uint64_t HELPER(waddau)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t rd)
{
    uint64_t acc = rd;
    return acc + rs1 + rs2;
}
 ...
 */
uint64_t HELPER(wsuba)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t rd)
{
    int64_t a = (int32_t)rs1;
    int64_t b = (int32_t)rs2;
    int64_t acc = (int64_t)rd;
 ...
 */
uint64_t HELPER(wsubau)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t rd)
{
    uint64_t acc = rd;
    return acc + rs1 - rs2;
}
 ...
 */
uint32_t HELPER(predsum_dbs)(CPURISCVState *env, uint32_t rs1_lo, uint32_t rs1_hi, uint32_t rs2)
{
 ...
 */
uint32_t HELPER(predsumu_dbs)(CPURISCVState *env, uint32_t rs1_lo, uint32_t rs1_hi, uint32_t rs2)
{
    uint64_t sum = rs2;
 ...
 */
uint32_t HELPER(predsum_dhs)(CPURISCVState *env, uint32_t rs1_lo, uint32_t rs1_hi, uint32_t rs2)
{
    int64_t sum = (int32_t)rs2;
    int64_t s1 = ((int64_t)rs1_hi << 32) | rs1_lo;
 ...
 */
uint32_t HELPER(predsumu_dhs)(CPURISCVState *env, uint32_t rs1_lo, uint32_t rs1_hi, uint32_t rs2)
{
    uint64_t sum = rs2;
    uint64_t s1 = ((uint64_t)rs1_hi << 32) | rs1_lo;
...
/**
 * PNSRARI.B - Narrowing arithmetic shift right with rounding immediate (64-bit to 32-bit)
 */
...
/**
 * PNSRAR.BS - Narrowing arithmetic shift right with rounding from register (64-bit to 32-bit)
 */
...
/**
 * PNCLIPRI.B - Narrowing clip signed with rounding (64-bit to 32-bit) with immediate shift
 */
...
/**
 * PNCLIPRIU.B - Narrowing clip unsigned with rounding (64-bit to 32-bit) with immediate shift
 */
...
/**
 * PNCLIPR.BS - Narrowing clip signed with rounding from register (64-bit to 32-bit)
 */
...
/**
 * PNCLIPRU.BS - Narrowing clip unsigned with rounding from register (64-bit to 32-bit)
 */
...
/**
 * PNSRLI.H - Narrowing logical shift right immediate (64-bit to 32-bit, word to halfword)
 */
...
/**
 * PNSRAI.H - Narrowing arithmetic shift right immediate (64-bit to 32-bit, word to halfword)
 */
...
/**
 * PNSRARI.H - Narrowing arithmetic shift right with rounding immediate (64-bit to 32-bit, word to halfword)
 */
...
/**
 * PNSRL.HS - Narrowing logical shift right from register (64-bit to 32-bit, word to halfword)
 */
...
/**
 * PNSRA.HS - Narrowing arithmetic shift right from register (64-bit to 32-bit, word to halfword)
 */
...
/**
 * PNSRAR.HS - Narrowing arithmetic shift right with rounding from register (64-bit to 32-bit, word to halfword)
 */
...
/**
 * PNCLIPR.HS - Narrowing signed clip with rounding from register (word to halfword)
...
/**
 * PNCLIPRI.H - Narrowing signed clip with rounding from immediate shift (word to halfword)
...
/**
 * PNCLIPRU.HS - Narrowing unsigned clip with rounding from register (word to halfword)
...
/**
 * PNCLIPRIU.H - Narrowing unsigned clip with rounding from immediate shift (word to halfword)
...
/**
 * NSRARI - Narrowing arithmetic shift right with rounding immediate (64-bit to 32-bit)
 */
...
/**
 * NSRAR - Narrowing arithmetic shift right with rounding from register (64-bit to 32-bit)
 */
...
/**
 * NCLIPRI - Narrowing clip signed with rounding and immediate shift (64-bit to 32-bit)
 */
...
/**
 * NCLIPRIU - Narrowing clip unsigned with rounding and immediate shift (64-bit to 32-bit)
 */
...
/**
 * NCLIPRU - Narrowing clip unsigned with rounding from register (64-bit to 32-bit)
 */
 ...
 */
uint64_t HELPER(pmqwacc_h)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
...
/**
 * PMQRWACC.H - Packed Q-format halfword to word multiply accumulate with rounding
 */
uint64_t HELPER(pmqrwacc_h)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
 ...
 */
uint64_t HELPER(pwmacc_h)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
...
/**
 * PWMACCSU.H - Widening signed x unsigned multiply accumulate (halfword to word)
 */
uint64_t HELPER(pwmaccsu_h)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
 ...
 */
uint64_t HELPER(pwmaccu_h)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t dest)
{
    uint64_t rd = 0;
 ...
 */
uint64_t HELPER(mqwacc)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t dest)
{
 ...
 */
uint64_t HELPER(mqrwacc)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t dest)
{
    int64_t s1 = (int64_t)(int32_t)rs1;
    int64_t s2 = (int64_t)(int32_t)rs2;
    int64_t d = (int64_t)dest;
 ...
 */
uint64_t HELPER(wmacc)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t dest)
{
    return (uint64_t)((int64_t)(int32_t)rs1 * (int64_t)(int32_t)rs2 + (int64_t)dest);
}

/**
 * WMACCSU - Widening multiply accumulate signed x unsigned (32-bit to 64-bit, RV32)
 */
uint64_t HELPER(wmaccsu)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t dest)
{
 ...
 */
uint64_t HELPER(wmaccu)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t dest)
{
...
/**
 * PM2WADDSU.H - Add two widening products (signed x unsigned, halfword to doubleword)
 */
...
/**
 * PM2WADDA.H - Add two widening products with accumulate (halfword to doubleword)
 */
uint64_t HELPER(pm2wadda_h)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t dest)
{
...
/**
 * PM2WADDASU.H - Add two widening products with accumulate (signed x unsigned, halfword to doubleword)
 */
uint64_t HELPER(pm2waddasu_h)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t dest)
{
	int16_t s1_h0 = (int16_t)EXTRACT16(rs1, 0);
    int16_t s1_h1 = (int16_t)EXTRACT16(rs1, 1);
...
/**
 * PM2WADDAU.H - Add two widening products with accumulate (unsigned, halfword to doubleword)
 */
uint64_t HELPER(pm2waddau_h)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t dest)
{
...
/**
 * PM2WADDA.HX - Add two widening cross products with accumulate (halfword to doubleword)
 */
uint64_t HELPER(pm2wadda_hx)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t dest)
{
    int16_t s1_h0 = (int16_t)EXTRACT16(rs1, 0);
    int16_t s1_h1 = (int16_t)EXTRACT16(rs1, 1);
    int16_t s2_h0 = (int16_t)EXTRACT16(rs2, 0);
...
/**
 * PM2WSUBA.H - Subtract two widening products with accumulate (halfword to doubleword)
 */
uint64_t HELPER(pm2wsuba_h)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t dest)
{
    int16_t s1_h0 = (int16_t)EXTRACT16(rs1, 0);
    int16_t s1_h1 = (int16_t)EXTRACT16(rs1, 1);
    int16_t s2_h0 = (int16_t)EXTRACT16(rs2, 0);
...
/**
 * PM2WSUBA.HX - Subtract two widening cross products with accumulate (halfword to doubleword)
 */
uint64_t HELPER(pm2wsuba_hx)(CPURISCVState *env, uint32_t rs1, uint32_t rs2, uint64_t dest)
{
    int16_t s1_h0 = (int16_t)EXTRACT16(rs1, 0);
    int16_t s1_h1 = (int16_t)EXTRACT16(rs1, 1);
    int16_t s2_h0 = (int16_t)EXTRACT16(rs2, 0);
