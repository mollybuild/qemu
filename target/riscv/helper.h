...
DEF_HELPER_3(sati_32, tl, env, tl, tl)
DEF_HELPER_3(usati_32, tl, env, tl, tl)
DEF_HELPER_3(sslai, tl, env, tl, tl)
DEF_HELPER_3(srari_32, tl, env, tl, tl)
DEF_HELPER_3(ssha, tl, env, tl, tl)
DEF_HELPER_3(sshar, tl, env, tl, tl)
DEF_HELPER_3(mseq, tl, env, tl, tl)
DEF_HELPER_3(mslt, tl, env, tl, tl)
DEF_HELPER_3(msltu, tl, env, tl, tl)
